        ...
        <div>
          ...
          {timelineData && (
            <div style={{ marginTop: "40px" }}>
              <h3>📊 시간대별 활동 분석</h3>
              <Bar data={timelineData} options={{ responsive: true, plugins: { legend: { position: 'top' } }, scales: { y: { beginAtZero: true, title: { display: true, text: '시간 (초)' } }, x: { title: { display: true, text: '10초 단위 시간' } } } }} />
            </div>
          )}
          ...
          {blinkGraphData && (
            <div style={{ marginTop: "40px" }}>
              ...
              <Bar data={blinkGraphData} options={{ responsive: true, plugins: { legend: { position: 'top' }, title: { display: true, text: '눈 깜빡임 + 졸음 감지' } }, scales: { y: { beginAtZero: true, suggestedMax: 10, title: { display: true, text: '깜빡임 횟수' } }, x: { title: { display: true, text: '시간 (60초 간격)' } } } }} />
            </div>
          )}
          ...
          {focusScoreGraphData && (
            <div style={{ marginTop: "40px" }}>
              <h3>🎯 10초 단위 집중도 점수</h3>
              <Bar data={focusScoreGraphData} options={{ responsive: true, plugins: { legend: { position: 'top' }, title: { display: true, text: '집중도 점수 (10초 단위)' } }, scales: { y: { beginAtZero: true, suggestedMax: 100, title: { display: true, text: '점수' } }, x: { title: { display: true, text: '시간 (HH:MM:SS)' } } } }} />
            </div>
          )}
